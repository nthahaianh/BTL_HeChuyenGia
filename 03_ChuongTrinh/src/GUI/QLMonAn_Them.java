...
public class QLMonAn_Them extends javax.swing.JDialog {

    public QLMonAn_Them(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//    @SuppressWarnings("unchecked")
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            String ma = "mon"+txtMa.getText().toString();
            if(maBiTrung(ma))
                throw new Exception("Đã tồn tại mã món ăn này!");
            if(txtTen.getText().isBlank())
                throw new Exception("Không để trống tên món ăn!");
            SuKien monMoi = new SuKien();
            monMoi.setMaSuKien(ma);
            monMoi.setNoiDung(txtTen.getText().trim());
            SuKienDB.addMon(monMoi);
            this.dispose();
        } catch (Exception e) {
    ...
    private boolean maBiTrung(String text) {
        ArrayList<SuKien> allMon = SuKienDB.getAllMon();
